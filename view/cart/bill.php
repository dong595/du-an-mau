        ...
        <form action="index.php?act=billConfirm" method="post">
                ...
                <div class=" boxcontent formtaikhoan">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td style="border: unset;"><input value="<?=$userAddress?>" placeholder="Địa chỉ"
                                    type="text" name="userAddress"></td>
                        </tr>
                        <tr>
            ...
            <div class="fl mb">
                ...
                <div class="boxcontent">
                    <input style="margin: 10px" name="pttt" type="radio" value="1" checked>Trả tiền khi nhận hàng
                    <input style="margin: 10px" name="pttt" type="radio" value="2">Chuyển khoản ngân hàng
                    <input style="margin: 10px" name="pttt" type="radio" value="3">Thanh toán online
                </div>
            </div>
            <div class=" fl mb ">
            ...
            <div class="fl mb bill">
                <input type="submit" name="acp" value="Đồng ý đặt hàng">
            </div>
        </form>
    </div>
